...
plotClimate<- function(outfilename='debug_climate'){
  ...
  par(new=TRUE)
  plot(MVSE_data$date,MVSE_data$T,t='l',col="cadetblue4",xaxt="n",yaxt="n",xlab="",lwd=2,ylab="", ylim=c(0,40))
  axis(4)
...
plotEmpiricalIndexP<- function(outfilename='debug_indexP'){
  ...
  plot(MVSE_data$date,MVSE_results$indexP,t='l',xaxt='n', ylab='values', xlab='date', main='estimated index P', col='tomato3', lwd=3, ylim=c(0,12))
  ...
  for(ss in 1:length(MVSE_results$indexPSmooth)){
    ...
    plot(MVSE_data$date,MVSE_results$indexP,t='l',xaxt='n', ylab='values', xlab='date', main=mmain, col='tomato3', lwd=3, ylim=c(0,12))
    lines(MVSE_data$date,MVSE_results$indexPl,col='grey77')
    lines(MVSE_data$date,MVSE_results$indexPu,col='grey77')
    lines(MVSE_data$date,MVSE_results$indexP,col='tomato3')
